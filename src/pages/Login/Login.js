...
export default function Login(props) {
    ...
    return (
        ...
        {/* cách 1 sk formik no đã chặn evendefault giúp mình rồi */}
        {/* <form onSubmit={(e) => {
            e.preventDefault();
            formik.handleSubmit(e);
        }} className="lg:w-1/2 xl:max-w-screen-sm"> */}
            {/* cách 2 chặn load lại trang nhiều lần */}
            <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div className="cursor-pointer flex items-center">
                    <div>
                        <svg className="w-10 text-indigo-500" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 225 225" style={{ enableBackground: 'new 0 0 255 225' }} xmlSpace="preserve">
                    ...
                    <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold"> <img src="https://cyberlearn.vn/wp-content/uploads/2020/03/cyberlearn-min-new-opt2.png" alt="cyberlearn.vn" /></div>
                </div>
            </div>
